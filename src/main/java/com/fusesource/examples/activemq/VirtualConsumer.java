...
public class VirtualConsumer {
    private static final Log LOG = LogFactory.getLog(VirtualConsumer.class);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            LOG.info("Start consuming messages from " + queue + " with " + MESSAGE_TIMEOUT_MILLISECONDS + "ms timeout");
